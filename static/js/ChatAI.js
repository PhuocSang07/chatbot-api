...
class ChatAI {
        ...
        fetch('http://localhost:5000/', { 
            ...
            let textInterval = setInterval(() => {
                if (msg[0]) {
                    ...
                    msgElement.innerHTML = msgElement.innerHTML.replace(/\*\*(.*?)\*\*/g, "<strong>$1</strong>");
                    msgElement.innerHTML = msgElement.innerHTML.replace(/\* (.*?)/g, "- $1");   
                    msgElement.innerHTML = msgElement.innerHTML.replace(/\*(.*?)\*/g, "<em>$1</em>");
    ...
    _welcomePageTemplate() {
        return `
            <div class="welcome">
                <span class="ver">${this.options.version}</span>
                <!-- <h1>Tư vấn tuyển sinh 10 </h1> -->
                <!-- <h1>THPT Ung Văn Khiêm</h1> -->
            </div>
        `;
    }
